...
package LBNL71T_MPC
  ...
  RapidMPC_BoundaryConditions_WeatherProcessor_fmu
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu
    annotation (Placement(transformation(extent={{-294,-80},{-234,-20}})));
  equation
  ...
  connect(mpc.weaPAtm, weatherProcessor.weaPAtm) annotation (Line(points={{
          -118.583,128.4},{-376,128.4},{-376,102},{-318,102}}, color={0,0,
          127}));
  connect(mpc.weaTDewPoi, weatherProcessor.weaTDewPoi) annotation (Line(
        points={{-118.583,114},{-136,114},{-136,146},{-378,146},{-378,96},{
          -318,96}}, color={0,0,127}));
  connect(mpc.weaTDryBul, weatherProcessor.weaTDryBul) annotation (Line(
        points={{-118.583,99.6},{-138,99.6},{-138,144},{-376,144},{-376,
          89.8},{-318,89.8}}, color={0,0,127}));
  connect(mpc.weaRelHum, weatherProcessor.weaRelHum) annotation (Line(
        points={{-118.583,85.2},{-140,85.2},{-140,142},{-374,142},{-374,
          83.8},{-318,83.8}}, color={0,0,127}));
  connect(mpc.weaNOpa, weatherProcessor.weaNOpa) annotation (Line(points={{
          -118.583,70.8},{-142,70.8},{-142,140},{-372,140},{-372,77.8},{
          -318,77.8}},
                  color={0,0,127}));
  connect(mpc.weaCelHei, weatherProcessor.weaCelHei) annotation (Line(
        points={{-118.583,56.4},{-144,56.4},{-144,138},{-370,138},{-370,
          71.8},{-318,71.8}}, color={0,0,127}));
  ...
  connect(mpc.weaWinDir, weatherProcessor.weaWinDir) annotation (Line(
        points={{-118.583,13.2},{-150,13.2},{-150,132},{-364,132},{-364,
          53.6},{-318,53.6}}, color={0,0,127}));
  connect(mpc.weaHHorIR, weatherProcessor.weaHHorIR) annotation (Line(
        points={{-118.583,-1.2},{-152,-1.2},{-152,130},{-362,130},{-362,
          47.8},{-318,47.8}}, color={0,0,127}));
  connect(mpc.weaHDirNor, weatherProcessor.weaHDirNor) annotation (Line(
        points={{-118.583,-15.6},{-154,-15.6},{-154,128},{-360,128},{-360,
          41.8},{-318,41.8}}, color={0,0,127}));
  connect(mpc.weaHGloHor, weatherProcessor.weaHGloHor) annotation (Line(
        points={{-118.583,-30},{-156,-30},{-156,126},{-358,126},{-358,36},{
  ...
  connect(weatherProcessor.weaPAtm,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaPAtm) annotation (
      Line(points={{-318,102},{-352,102},{-352,-50},{-294,-50}}, color={0,0,
          127}));
  connect(weatherProcessor.weaTDewPoi,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaTDewPoi)
    annotation (Line(points={{-318,96},{-318,96},{-350,96},{-350,-50},{-294,
          -50}}, color={0,0,127}));
  connect(weatherProcessor.weaTDryBul,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaTDryBul)
    annotation (Line(points={{-318,89.8},{-336,89.8},{-336,90},{-348,90},{
          -348,-50},{-294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaRelHum,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaRelHum) annotation (
     Line(points={{-318,83.8},{-336,83.8},{-336,84},{-346,84},{-346,-50},{
          -294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaNOpa,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaNOpa) annotation (
      Line(points={{-318,77.8},{-344,77.8},{-344,78},{-344,-18},{-344,-50},
          {-294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaCelHei,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaCelHei) annotation (
     Line(points={{-318,71.8},{-330,71.8},{-330,72},{-342,72},{-342,-50},{
          -294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaNTot,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaNTot) annotation (
      Line(points={{-318,66},{-340,66},{-340,-38},{-340,-50},{-294,-50}},
        color={0,0,127}));
  connect(weatherProcessor.weaWinSpe,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaWinSpe) annotation (
     Line(points={{-318,60},{-338,60},{-338,-50},{-294,-50}}, color={0,0,
          127}));
  connect(weatherProcessor.weaWinDir,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaWinDir) annotation (
     Line(points={{-318,53.6},{-328,53.6},{-328,54},{-336,54},{-336,-50},{
          -294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaHHorIR,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaHHorIR) annotation (
     Line(points={{-318,47.8},{-334,47.8},{-334,-50},{-294,-50}}, color={0,
          0,127}));
  connect(weatherProcessor.weaHDirNor,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaHDirNor)
    annotation (Line(points={{-318,41.8},{-326,41.8},{-326,42},{-332,42},{
          -332,-50},{-294,-50}}, color={0,0,127}));
  connect(weatherProcessor.weaHGloHor,
    rapidMPC_BoundaryConditions_WeatherProcessor_fmu.weaHGloHor)
    annotation (Line(points={{-318,36},{-330,36},{-330,-50},{-294,-50}},
        color={0,0,127}));
